...
public class UsuariosCrud extends CrudBase {
    ...
    protected void prepareInsertStatement(ArrayList<Object> data) throws SQLException {
        ...
        insertStatement.setString(2, data.get(0).toString());
        insertStatement.setString(3, data.get(0).toString());
        insertStatement.setString(4, data.get(0).toString());
        insertStatement.setString(5, data.get(0).toString());
        insertStatement.setString(6, data.get(0).toString());
    }
    ...
    protected void prepareUpdateStatement(ArrayList<Object> data, int id) throws SQLException {
        ...
        updateStatement.setString(2, data.get(0).toString());
        updateStatement.setString(3, data.get(0).toString());
        updateStatement.setString(4, data.get(0).toString());
        updateStatement.setString(5, data.get(0).toString());
        updateStatement.setString(6, data.get(0).toString());
